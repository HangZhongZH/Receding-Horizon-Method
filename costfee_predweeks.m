function  costfee_predtotal = costfee_predweeks(stock_end_last, h_pred, h_ctrl, y, r, MCnum)
...
for i = 1: MCnum
    ...
    for j = 1: h_pred
        ...
        %not include the last week
        [costfee, stock_end] = costfee_oneweek(stock_end_last2, y1, r);
